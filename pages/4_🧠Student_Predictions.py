...
#         df_filtred['codigo'] = df_filtred['codigo'].apply(lambda x: str(x))
#         df_filtred = df_filtred[df_filtred['codigo'] == student_code]
#         df_polar = df_filtred.copy()
#         df_polar.fillna(0,inplace=True)
#         st.write('Scores of the Student Selected')
#         df1,df2,df3 = st.columns((1,3,1))
#         with df2:
