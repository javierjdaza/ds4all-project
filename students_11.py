...
def student_11():
    ...
    def create_column_feature_grades_11(name :str):
    ...
    # =======================
    with c1:
        biologia_sim_11 = create_column_feature_drill('biologia_sim_11')
    with c2:
        cts_sim_11 = create_column_feature_drill('cts_sim_11')
    with c3:
        competencias_ciudadanas_sim_11 = create_column_feature_drill('competencias_ciudadanas_sim_11')
    with c4:
        fisica_sim_11 = create_column_feature_drill('fisica_sim_11')
    with c5:
        ingles_sim_11 = create_column_feature_drill('ingles_sim_11')
    with c6:
        lectura_critica_sim_11 = create_column_feature_drill('lectura_critica_sim_11')
    with c7:
        matematicas__espec__sim = create_column_feature_drill('matematicas_(espec)_sim_11')
    with c8:
        matematicas__cuant__sim = create_column_feature_drill('matematicas_(cuant)_sim_11')
    with c9:
        quimica_sim_11 = create_column_feature_drill('quimica_sim_11')
    with c10:
        sociales_sim_11 = create_column_feature_drill('sociales_sim_11')
    ...
    'economia_notas_11': economia_notas_11,
    'espaniol_notas_11': espaniol_notas_11,
    'filosofia_notas_11': filosofia_notas_11,
    'espaniol_notas_11': espaniol_notas_11,
    'matematicas_notas_11': matematicas_notas_11,
    'fisica_notas_11' : fisica_notas_11,
    'quimica_notas_11': quimica_notas_11,
    'ingles_notas_11': ingles_notas_11,
    'matematicas_notas_11':matematicas_notas_11,
    'disciplina_notas_11':disciplina_notas_11,
    'biologia_sim_11' : biologia_sim_11,
    'cts_sim_11' : cts_sim_11,
    'competencias_ciudadanas_sim_11' : competencias_ciudadanas_sim_11,
    'fisica_sim_11' : fisica_sim_11,
    'ingles_sim_11' : ingles_sim_11,
    'lectura_critica_sim_11' : lectura_critica_sim_11,
    'matematicas_(espec)_sim_11' : matematicas__espec__sim,
    'matematicas_(cuant)_sim_11' : matematicas__cuant__sim,
    'quimica_sim_11' : quimica_sim_11,
    'sociales_sim_11' : sociales_sim_11,
    }
